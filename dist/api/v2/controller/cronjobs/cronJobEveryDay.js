...
exports.cronEveryDay = void 0;
const dbV2_1 = __importDefault(require("../../../../dbV2"));
const utility = __importStar(require("../../helper/utility"));
const development_1 = __importDefault(require("../../config/development"));
const async_1 = __importDefault(require("async"));
const cronEveryDay = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // ====================================================================================================
        const expireCardCron = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        async_1.default.parallel(multiFnc, function (err, result) {
            if (err)
                return console.log("Something went wrong or failed to run async parallel function");
...
exports.cronEveryDay = cronEveryDay;
// ====================================================================================================
// ====================================================================================================
