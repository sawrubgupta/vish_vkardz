...
export default {
    card: {
        ...
        products: {
            ...
            // productDetail
            productDetail: {
                nullProductId: "Product id is required!", // Invalid Product Id
                successMsg: "Products details are here",
                noDataFoundMsg: noDataFoundMsg
                // failedMsg: "Failed to add address, try again"
            },
        ...
        purchase: {
            ...
            cardPurchase: {
                ...
                invalidOrderType: "Order type not define", //order type must be online and offline
        ...
        rating: {
            // productRating
            productRating: {
                notBuy: "Sorry! You are not allowed to review this product since you haven't bought it.", // if product not buy by user
            ...
            // productReviews
            reviewList: {
                nullProductIdMsg: "Product id is required!", // Invalid Product Id
    ...
    profile: {
        ...
        profile: {
            ...
            updateVcardinfo: {
                nullUserId: "User Id is required!",
                dupliValMsg: "", // pass msg in api because dupli value mentioned
                successMsg: "Profile updated successfully !",
                failedMsg: "Failed to update the user, please try again later !",
            },
            // updateImage
