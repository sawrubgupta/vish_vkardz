...
const addTeamMember = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const [permissionRows] = yield dbV2_1.default.query(checkPermissionsql);
        try {
        ...
        if (rows.affectedRows > 0) {
            ...
            const [memberRows] = yield dbV2_1.default.query(result);
            ...
            try {
                ...
                for (var _m = true, permissions_2 = __asyncValues(permissions), permissions_2_1; permissions_2_1 = yield permissions_2.next(), _j = permissions_2_1.done, !_j;) {
                    ...
                    try {
                        ...
                        const [permissionRows] = yield dbV2_1.default.query(permissionSql, permissionVALUES);
                    }
                    finally {
                        _m = true;
                    }
            ...
            try {
                for (var _r = true, rows_1 = __asyncValues(rows), rows_1_1; rows_1_1 = yield rows_1.next(), _o = rows_1_1.done, !_o;) {
                    ...
                    try {
                        ...
                        const [permissionRows] = yield dbV2_1.default.query(permissionSql);
...
const teamMemberDetail = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (rows.length > 0) {
            ...
            const [memberRows] = yield dbV2_1.default.query(permissionSql);
            let permission = {};
