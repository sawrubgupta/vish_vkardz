...
const referController = __importStar(require("../../controller/referral/refer"));
...
referralRouter.post("/applyReferCode", authorization_controller_1.authenticatingToken, referController.useReferCode);
