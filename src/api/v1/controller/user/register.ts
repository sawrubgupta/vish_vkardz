...
console.log("data", data);
        ...
        const VALUES = [name, name, email, email, hash, username, dial_code, qrData.data, phone, 'USD', dial_code, phone, country, referralCode, 100, 1, 0, 1, 1, 1, 0, justDate, justDate, justDate, endDate, 16, 'vcard', fcmToken, facebookId, googleId, appleId];                    
        const [userData]:any = await pool.query(sql, VALUES);
