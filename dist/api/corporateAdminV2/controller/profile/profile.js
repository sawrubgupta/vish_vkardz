...
const userList = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const [subAdminData] = yield dbV2_1.default.query(checkSubAdmin);
        ...
        const getPageQuery = `SELECT COUNT(id) AS length FROM users WHERE deleted_at IS NULL AND admin_id = ${userId}`;
        ...
        const [adminRows] = yield dbV2_1.default.query(adminSql);
...
const updateUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (userData.length > 0) {
            ...
            const [rows] = yield dbV2_1.default.query(updateSql, VALUES);
