...
const updateFeatureController = __importStar(require("../../controller/features/manageFeature"));
...
featureRouter.patch("/updateFeatures", authorization_controller_1.authenticatingToken, updateFeatureController.updateUserFeaturesStatus);
