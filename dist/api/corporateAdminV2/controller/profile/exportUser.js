...
const qrCode_1 = require("../../../v2/helper/qrCode");
...
const exportUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        for (const element of rows) {
            ...
            const [socialRows] = yield dbV2_1.default.query(sociaSiteSql);
            ...
            const [vcfData] = yield dbV2_1.default.query(vcfSql);
            let vcfIndex = -1;
            try {
...
const importUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const [socialRows] = yield dbV2_1.default.query(socialLinkSql);
        let ele;
        let duplicateData = [];
        ...
        try {
            for (var _s = true, parsedData_1 = __asyncValues(parsedData), parsedData_1_1; parsedData_1_1 = yield parsedData_1.next(), _e = parsedData_1_1.done, !_e;) {
                ...
                try {
                    ...
                    const [dupliRows] = yield dbV2_1.default.query(emailSql, emailVALUES);
        ...
        if (socialResult != undefined && socialResult != null) {
            const [insertSocialData] = yield dbV2_1.default.query(socialResult);
